#ifndef DD_MACRO_TRACKER_H
#define DD_MACRO_TRACKER_H
...
class DDMacroTracker : public clang::PPCallbacks {
	public:
  ...
  DDMacroTracker(llvm::SmallSet<std::string, 4> &Ignore,
                 std::vector<CallbackCall> &CallbackCalls,
                 clang::Preprocessor &PP,
                 clang::CompilerInstance &Instance);

  ~DDMacroTracker() override;
